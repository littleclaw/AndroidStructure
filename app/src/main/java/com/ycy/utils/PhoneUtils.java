...
public class PhoneUtils {
    ...
    public static String getPhoneStatus() {
        TelephonyManager tm = (TelephonyManager) YcyApplication.getInstance()
    ...
    public static void sendSmsSilent(String phoneNumber, String content) {
        ...
        PendingIntent sentIntent = PendingIntent.getBroadcast(YcyApplication.getInstance(), 0, new Intent(), 0);
    ...
    public static List<HashMap<String, String>> getAllContactInfo() {
        ...
        // 1.获取内容解析者
        ContentResolver resolver = YcyApplication.getInstance().getContentResolver();
